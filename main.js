...
startImage.src = "./assets/images/cat_start.png";
// (3) 게임 오버
...
rtanAImage.src = "./assets/images/cat1.png";
// (6) 달리는 르탄이 B
const rtanBImage = new Image();
rtanBImage.src = "./assets/images/cat2.png";
// (7) 게임 오버 르탄이
const rtanCrashImage = new Image();
rtanCrashImage.src = "./assets/images/cat3.png";
// (8) 장애물
